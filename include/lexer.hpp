...
enum TK_TYPE {
    TK_SELECT, TK_INSERT, TK_CREATE, TK_UPDATE, TK_INTO, TK_FROM, TK_SET, TK_WHERE, TK_AND, TK_TABLE, TK_VALUES, TK_ORDER, TK_BY, TK_ID, TK_NUMBER, TK_STRING, TK_TRUE, TK_FALSE,
