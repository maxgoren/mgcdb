...
enum TK_TYPE {
    TK_SELECT, TK_INSERT, TK_CREATE, TK_UPDATE, TK_DELETE, TK_INTO, TK_FROM, TK_SET, TK_WHERE, TK_AND, TK_TABLE, TK_JOIN, TK_VALUES, TK_ORDER, TK_BY, TK_AS, TK_ID, TK_NUMBER, TK_STRING, TK_TRUE, TK_FALSE,
